...
static final String sFileName = "BookDetail.jsp";
  ...
  String doNothing(final String dirtyParam)
  {

    final String noSecurityIssueHere =  dirtyParam;
    /************* SQL INJECTION FIX *************
     * The following code will fix Second Order SQL Injection.
     *
     * The commented out line below will assign noSecurityIssuesHere to dirtyParam.  The dirtyParam has a replaceAll appended to it,
     * which will replace all ' with nothing which will prevent a user from escaping a sql statement.
     *
